    ...
    const ENV = {
        ...
        featureFlagNames: {
            routes: {
                ...
                'registries.start': 'ember_registries_submission',
                'registries.drafts': 'ember_registries_submission',
                'registries.drafts.index': 'ember_registries_submission',
                'registries.drafts.draft': 'ember_registries_submission',
                'registries.drafts.draft.form': 'ember_registries_submission',
                'registries.drafts.draft.review': 'ember_registries_submission',
                'registries.forms': 'ember_registries_submission',
                'registries.forms.help': 'ember_registries_submission',
