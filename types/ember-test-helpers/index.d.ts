...
declare module '@ember/test-helpers/dom/trigger-key-event' {
    ...
    export default function(target: Target, eventType: KeyEvent, modifiers?: KeyModifiers): Promise<void>;
}
...
declare module '@ember/test-helpers/dom/wait-for' {
    ...
    export default function(selector: string, options?: Options): Element | Element[];
}
...
declare module '@ember/test-helpers/application' {
    ...
    export function getApplication(): ApplicationInstance;
    export function setApplication(applicationInstance: ApplicationInstance): void;
}
/* eslint-enable import/export, import/no-duplicates */
