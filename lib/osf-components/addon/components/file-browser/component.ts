...
export default class FileBrowser extends Component {
    ...
    get link(): string | undefined {
        const { guid } = this.selectedItems.get('firstObject') as unknown as File;
    ...
    selectItem(this: FileBrowser, currentItem: File) {
        ...
        if (this.selectedItems.length > 1) {
            ...
            const otherItem = this.selectedItems.get('firstObject') as unknown as File;
    ...
    @action
    viewItem() {
        const item = this.selectedItems.get('firstObject') as unknown as File;
    ...
    @action
    downloadItem() {
        window.location.href = (this.selectedItems.get('firstObject') as unknown as File).links.download;
    }
    ...
    renameConflict(this: FileBrowser, conflict: string): void {
        ...
        const selectedItem = this.selectedItems.get('firstObject') as unknown as File;
    ...
    copyLink(this: FileBrowser) {
        ...
        (this.selectedItems.get('firstObject') as unknown as File).getGuid();
    }
