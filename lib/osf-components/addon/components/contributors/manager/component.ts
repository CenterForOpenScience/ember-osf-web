...
export default class ContributorsManager extends Component {
    ...
    @enqueueTask({ withTestWaiter: true, on: 'init' })
    ...
    get shouldShowLoadMore() {
        const fetchContributorsTask = taskFor(this.fetchContributors);
        return !fetchContributorsTask.isRunning
            && fetchContributorsTask.lastComplete
            && this.hasMore
            && !this.isDragging;
    }
