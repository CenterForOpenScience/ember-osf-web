...
/**
 * Route mixin for login based on OSF cookie authentication.
 * Intended to be used in tandem with OsfCookieLoginController mixin.
...
export default Mixin.create({
    ...
    beforeModel() {
        ...
        return this.get('session').authenticate('authenticator:osf-cookie')
            .catch(err => console.log('Authentication failed: ', err)); // eslint-disable-line no-console
    },
});
