...
/**
 * Controller mixin for authentication-agnostic login:
 * Defines the application at runtime to use the authentication method specified
 * in environment config. Intended to be used in tandem with OsfAuthController mixin.
 *
