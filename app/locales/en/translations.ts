...
export default {
    ...
    sign_up_form: {
        ...
        error_email_address: 'Please enter a proper email address.',
        error_password_email: 'Your password cannot be the same as your email address.',
        error_password_old: 'Your new password cannot be the same as your old password.',
        error_password_match: 'Passwords must match.',
        error_characters_minimum: 'Please enter at least {{min}} characters.',
        error_characters_maximum: 'Please enter no more than {{max}} characters.',
        error_email_match: 'Email addresses must match.',
        error_recaptcha: 'Please complete reCAPTCHA',
