...
module('Integration | routes | institutions | dashboard | -components | departments-panel', hooks => {
    ...
    test('it renders', async function(assert) {
        ...
        await render(hbs`<Institutions::Dashboard::-Components::DepartmentsPanel
