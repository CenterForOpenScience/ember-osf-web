...
import { commentUpdate, reportDelete } from './views/comment';
...
export default function(this: Server) {
    ...
    this.patch('/comments/:id', commentUpdate);
    osfResource(this, 'comment-report');
    osfNestedResource(this, 'comment', 'reports', {
        except: ['delete'],
        path: '/comments/:parentID/reports',
        relatedModelName: 'comment-report',
    });
    this.del('/comments/:id/reports/:user_id', reportDelete);
