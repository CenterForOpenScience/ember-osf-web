...
export interface MirageSubmissionAction {
    ...
    dateModified?: Date;
    /**
     * The is submit if the removed project should be added again for the collection submission action
     */
    isResubmit?: boolean;
    /**
     * The is admin remove determines if the project is removed by the project
     * admin or the collection moderator
     */
